...
///tmp init obj
	//                      unsigned, t_dvec3 pos      , double       , t_dvec3     ,	t__mat mat  t_dvec3			, double			,	double;
	//                       type   ,  pos             , radius       , dir         ,	t__mat mat  diffuse_color	, specular_exponent	,	albedo;
	...
	env->light_arr[0] = (t_lght){AMBIENT,		(t_dvec3){ 0, 0, 0 }, 0.1, (t_dvec3){255, 255, 255} };
...
t_env					*init_env(void)
{
	...
	|| !(env->uni_arr = (t_uni *)malloc(sizeof(t_uni) * (SPHERE_CNT + PLANE_CNT)))
